...
public class LinkCommand extends Command
{
	...
	public LinkCommand(DataHandler data, WorldHandler worlds, AddonHandler portal, boolean isForEndPortals)
	{
		super(isForEndPortals ? "link.end" : "link.nether"," Links "+(isForEndPortals ? "end":"nether") + " portals between worlds");
		this.d = data;
		this.plugin = portal;

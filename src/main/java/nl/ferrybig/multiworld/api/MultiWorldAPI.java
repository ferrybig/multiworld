...
public class MultiWorldAPI
{
	 ...
	 * @param plugin The main nl.ferrybig.multiworld plugin
	 */
	...
	/**
	 * checks when nl.ferrybig.multiworld is still loaded
	 ...
	 * @throws IllegalStateException When nl.ferrybig.multiworld is not enabled
	 */
	...
	/**
	 * Get al the worlds that are loaded by nl.ferrybig.multiworld

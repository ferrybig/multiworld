package nl.ferrybig.multiworld.translation;
...
public enum Translation implements PackedMessageData {
  ...
  COMMAND_DELETE_START("Starting to remove %world% from the nl.ferrybig.multiworld database"),
  COMMAND_DELETE_SUCCESS(
      "World %world% has been deleted from the nl.ferrybig.multiworld database."),
  ...
  COMMAND_CREATE_SUCCES(
      "Succesfully created world %world%, now you only need to do /mw load %world%"),
  ...
  COMMAND_LINK_PORTALHANDLER_NOT_FOUND(
      "Unable to acces portal handler addon, is it enabled inside the configuration?"),
  ...
  COMMAND_SAVE_SUCCES("Succesfully saves nl.ferrybig.multiworld data!"),
  COMMAND_SAVE_FAIL("Unable to save nl.ferrybig.multiworld data to disk! See console for details!"),
  COMMAND_RELOAD_SUCCES("Reloaded nl.ferrybig.multiworld configuration"),
  COMMAND_RELOAD_FAIL(
      "Failed to reload nl.ferrybig.multiworld configuration! See console for details"),

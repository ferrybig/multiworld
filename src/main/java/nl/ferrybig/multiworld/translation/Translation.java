...
public enum Translation implements PackedMessageData
{
	...
	COMMAND_DELETE_SUCCESS("World %world% has been deleted from the nl.ferrybig.multiworld database."),
	...
	COMMAND_RELOAD_FAIL("Failed to reload nl.ferrybig.multiworld configuration! See console for details"),
